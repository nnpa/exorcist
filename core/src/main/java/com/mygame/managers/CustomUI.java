...
public class CustomUI {
    ...
    // Фоны окон
    private Geometry loginBg, registerBg;

    // Фоны полей ввода (серые прямоугольники)
    private Geometry loginFieldBg, passFieldBg;
    private Geometry emailFieldBg, regLoginFieldBg, regPassFieldBg;
    ...
    // Вспомогательный класс для прямоугольников
    ...
    public CustomUI(SimpleApplication app) {
        this.app = app;
    ...
    private void createLoginScreen() {
        ...
        loginFieldBg = createQuad(fieldX - 5, fieldY - 5, fieldW + 10, fieldH + 10,
                new ColorRGBA(0.3f, 0.3f, 0.5f, 1f)); // Яркий фон для видимости
        ...
        passFieldBg = createQuad(fieldX - 5, fieldY - 5, fieldW + 10, fieldH + 10,
                new ColorRGBA(0.3f, 0.3f, 0.5f, 1f));
    ...
    private void createRegisterScreen() {
        ...
        emailFieldBg = createQuad(fieldX - 5, fieldY - 5, fieldW + 10, fieldH + 10,
                new ColorRGBA(0.3f, 0.3f, 0.5f, 1f));
        ...
        regLoginFieldBg = createQuad(fieldX - 5, fieldY - 5, fieldW + 10, fieldH + 10,
                new ColorRGBA(0.3f, 0.3f, 0.5f, 1f));
        ...
        regPassFieldBg = createQuad(fieldX - 5, fieldY - 5, fieldW + 10, fieldH + 10,
                new ColorRGBA(0.3f, 0.3f, 0.5f, 1f));
    ...
    private void appendChar(char c) {
        if (c == 8) return; // backspace обрабатывается отдельно
        switch (activeField) {
